...
require( $_SERVER["DOCUMENT_ROOT"] . "/" . "resources/functions/course/Course.class.phpss.php");
require( $_SERVER["DOCUMENT_ROOT"] . "/" . "resources/functions/course/Review.class.class.php");
