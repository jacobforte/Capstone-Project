 ...
 * @param rating The rating of the class using a number 1-5
 * @param instructor The name of the instructor that taught the class
 * @param semester The semester the class was taken in form of [Spring/Summer/Fall] + [Year]
 * @param campus The campus the class was taken at
 */
